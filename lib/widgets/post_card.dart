...
import 'package:skill_swap_app/screens/comments_screen.dart';
...
import 'package:skill_swap_app/widgets/like_animation.dart';
              ...
              children: [
                SizedBox(
                  ...
                  child: PageView.builder(
                    itemCount: (widget.snap['postUrls'] as List).length,
                    itemBuilder: (context, index) {
                      return Image.network(
                        widget.snap['postUrls'][index].toString(),
                        fit: BoxFit.cover,
                      );
                    },
                  ),
              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        'Type of Scam: ${widget.snap['category'] ?? 'Unknown'}',
                      ...
                      Text(
                        'Details: ${widget.snap['details'] ?? 'No details provided'}',
